...
import { REASON_WHEN_TRASH } from "../../game_logic/ReactionEffectManager.js";
import { getType } from "../../game_logic/basicCardFunctions.js";
/*
class  extends Card{
    constructor(){
        super("", new Cost(), `${Card.Type.TREASURE} ${Card.Type.HEIRLOOM}`, "Nocturne/Heirloom/");
    }
    play(){
    } 
}
...
class HauntedMirror extends Card {
  constructor() {
    super(
      "HauntedMirror",
      new Cost(0),
      `${Card.Type.TREASURE} ${Card.Type.HEIRLOOM}`,
      "Nocturne/Heirloom/"
    );
...
class Pasture extends Card {
  constructor() {
    super(
      "Pasture",
      new Cost(2),
      `${Card.Type.TREASURE} ${Card.Type.VICTORY} ${Card.Type.HEIRLOOM}`,
      "Nocturne/Heirloom/"
    );
  }
  async play() {

...
class Copper extends Card{
    constructor(player){
        super("Copper", new Cost(0), Card.Type.TREASURE, "Basic/", player);
        this.value = 1;
    }
    getInitAmount(){
        let amount = [46, 46, 39, 32, 85, 78];
        let player_count = Math.max(1, Math.min(opponentManager.getOpponentList().length + 1, 6));
...
class Silver extends Card{
    constructor(player){
        super("Silver", new Cost(3), Card.Type.TREASURE, "Basic/", player);
        this.value = 2;
    }
    getInitAmount(){
...
class Gold extends Card{
    constructor(player){
        super("Gold", new Cost(6), Card.Type.TREASURE, "Basic/", player);
        this.value = 3;
    }
    getInitAmount(){
...
class Platinum extends Card{
    constructor(player){
        super("Platinum", new Cost(9), Card.Type.TREASURE, "Basic/", player);
        this.value = 5;
    }
    getInitAmount(){
...
class Curse extends Card{
    constructor(player){
        super("Curse", new Cost(0), Card.Type.CURSE, "Basic/", player );
        this.score = -1;
    }
    getInitAmount(){
...
class Estate extends Card{
    constructor(player){
        super("Estate", new Cost(2), Card.Type.VICTORY, "Basic/", player );
        this.score = 1;
    }
    getInitAmount(){
...
class Duchy extends Card{
    constructor(player){
        super("Duchy", new Cost(5), Card.Type.VICTORY, "Basic/", player );
        this.score = 3;
    }
    getInitAmount(){
        let amount = [8, 8, 12, 12, 12, 12];
...
class Province extends Card{
    constructor(player){
        super("Province", new Cost(8), Card.Type.VICTORY, "Basic/", player );
        this.score = 6;
    }
    getInitAmount(){
...
class Colony extends Card{
    constructor(player){
        super("Colony", new Cost(11), Card.Type.VICTORY, "Basic/", player );
        this.score = 10;
    }
    getInitAmount(){
...
export {Copper, Silver, Gold, Platinum, Curse, Estate, Duchy, Province, Colony};